...
class Config(object):
    ...
    def from_file(self, filename):
        ...
        with open(filename, 'r') as f:
            self.cfg = AttrDict(yaml.full_load(f))
        return self.cfg
    
    def from_dict(self, dict_obj):
        """从字典加载配置"""
        self.cfg = AttrDict(dict_obj)
        return self.cfg
...
# 在文件末尾添加
parse_config = AttrDict()
parse_config.cfg = cfg
parse_config.cfg_from_file = cfg_from_file
parse_config.merge_cfg_from_file = merge_cfg_from_file
parse_config.merge_cfg_from_list = merge_cfg_from_list
parse_config.assert_and_infer_cfg = assert_and_infer_cfg
